<?php
    ...
    $sql = "INSERT INTO tbl_transaksi (no_transaksi, tanggal, id_kasir, total_bayar)
            VALUES ('$no_transaksi', '$tanggal', '$id_kasir', '$total')";
    ...
    if (mysqli_query($koneksi, $sql)) {
        ...
        $aktivitas = "Menyelesaikan transaksi No. $no_transaksi";
